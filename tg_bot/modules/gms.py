        ...
        if note.is_reply:
            ...
            try:
                ...
                if excp.message == "Entity_mention_user_invalid":
                    ...
                    message.reply_text("This game could not be sent, as it is incorrectly formatted. Ask "
                                       "@darkbeast842 if you can't figure out why!")
...
def save(bot: Bot, update: Update):
    ...
    note1 = sql.get_note(chat_id, note_name)
    ...
    msg.reply_text(
        "Yo! Added your {note_name} to data.\nGet names of those who play it with /get {note_name}, or #{note_name}".format(note_name=note_name))
...
def __chat_settings__(chat_id, user_id):
    ...
    return "There are `{}` games in this chat.".format(len(notes))
...
GET_HANDLER = CommandHandler("getgame", cmd_get, pass_args=True)
HASH_GET_HANDLER = RegexHandler(r"^#[^\s]+", hash_get)

SAVE_HANDLER = CommandHandler("addgame", save)
DELETE_HANDLER = CommandHandler("cleargame", clear, pass_args=True)
